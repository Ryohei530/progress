...
module WebpackBundleHelper
  ...
  def pro_manifest
    File.read("frontend/public/assets/manifest.json")
  end

  def dev_manifest
    OpenURI.open_uri("#{asset_server}/frontend/public/assets/manifest.json").read
  end

  def test_manifest
    File.read("frontend/public/assets-test/manifest.json")
  end
  ...
  def asset_bundle_path(entry, **options)
    valid_entry?(entry)
    asset_path("#{asset_server}/frontend/public/assets/" + manifest.fetch(entry), **options)
  end
end